...
function freezeColumn2(columnDef){
...
function freezeColumn(columnDef){
    var columnIdx = this.state.columnDefs.indexOf(columnDef);
    ...
    var first = true;
    var numToShow = parseInt(this.props.height) / 20;
...
function freezeColumn3(columnDef){
    var fixedIdx = this.state.columnDefs.indexOf(columnDef);
    this.state.fixedColumnIndex = fixedIdx;
    this.setState({});
};
...
function buildMenu(options) {
    ...
    var availableDefaultMenuItems = {
        ...
        freezeColumn : [
            <SubMenu
                menuItem={<span><i className="fa fa-thumb-tack"></i> Freeze Column</span>}
                subMenu={
                    <div className="rt-header-menu" style={subMenuStyles}>
                        <div className="menu-item" onClick={freezeColumn.bind(table,columnDef)}>
                            <i className="fa fa-thumb-tack"></i> Freeze to left</div>
                        <div className="menu-item" onClick={table.handleClearAllFilters}>Unfreeze</div>
                    </div>
                    }>
            </SubMenu>
        ]
